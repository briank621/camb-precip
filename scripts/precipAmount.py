...
for m in models:
	...
	plt.figure()
	DrawBarGraph.draw(years,yearsum_old,"Precipitation Amount Yearly","Year (%s)"%(m)," Amount (mm)")
...
for m in models:
	...
	plt.figure()
	DrawBarGraph.draw(years,yearsum_new,"Precipitation Amount Yearly","Year (%s)"%(m)," Amount (mm)")
